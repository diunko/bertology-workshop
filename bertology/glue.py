...
from ._train import add_generic_args, generic_train
from .utils import args_to_dict, dict_to_args
...
class GLUETransformer(BaseTransformer):
    ...
    @staticmethod
    def from_dict(d):
        parser = GLUETransformer.make_parser()
        args = dict_to_args(d, parser)
        logger.info('hparams: %s', json.dumps(args_to_dict(args), indent=2))
        return GLUETransformer(args)
